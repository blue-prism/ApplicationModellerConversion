...
| --------------------------- | ----------------------------------------- | ------------------------------------------------------------ | -------------------------------------------- | ------------------------------------------------------------ | :-------------: | :--------------: | :--------: |
| HTML Radio Button           | Radio Button (Web)                        | Set Checked                                                  | When *Set Checked* takes in a **false** flag | *Check Radio* in modern browser mode only implements **checked** state. Manual conversion is needed for *Set Checked* value set to **false**. |        X        |        X         |        X        |
...
| All non-Application Element | All                                       | Check URL, Check URL Domain, Check HTML Attribute            | Any                                          | Those conditions are not available in Chrome/Edge/Firefox.   |        X        |        X         | X |
...
| Change stage output data item type to work with the new action. | It is difficult to work out if it will be entirely positive to change the output data item type without affecting other usage of the same data item. |
